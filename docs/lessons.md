...
- **Two sibling briefings drift into two sources of truth.** The first blueprint pass shipped AGENTS.md and CLAUDE.md as separate copies; the 2026-09-18 pass made CLAUDE.md a symlink to AGENTS.md and folded that pass's four fumble entries into the hard rules. One file, one owner; the fumble log stays here.
