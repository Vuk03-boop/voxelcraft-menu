use voxelcraft::render::{
    ...
    FLAG_HI_SOFT_SHADOWS, FLAG_HI_COMPACT_SHADE_HIT, FLAG_HI_ISOLATE_GLASS, FLAG_HI_SHADOW_PASS, FLAG_HI_GLASS_QUAD, FLAG_HI_BIOME_BAKE, FLAG_HI_GLASS_SSR, SPEC_HI_MASK,
};
...
const ALL_HI: &[(u32, &str)] = &[
    ...
    (FLAG_HI_BIOME_BAKE, "FLAG_HI_BIOME_BAKE"),
    (FLAG_HI_GLASS_SSR, "FLAG_HI_GLASS_SSR"),
