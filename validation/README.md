...
Rust test sources are in `../tests/`. Their latest contract edits have not been executed. See `../BATCH-LOG.md` and `../HANDOFF.md` for implementation details and expected results.
